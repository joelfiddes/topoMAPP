...
"""
path2script = "./rsrc/toposub_post_2.R"

# main
def main(gridpath, samples, file1, targV, beg, end):
    """Main entry point for the script."""
    run_rscript_fileout(path2script,[gridpath, samples, file1, targV,beg, end])
...
if __name__ == '__main__':
    ...
    main(gridpath, samples, file1, targV, beg, end)
