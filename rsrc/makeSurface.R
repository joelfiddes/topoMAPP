...
#Seem different dates avaialbale now this error means date is not available "Error in lst_todo[[1]] : subscript out of bounds
# "2004-08-12" ,"2007-08-13", "2011-08-13"
